export const persianMessages = { //todo: handle english
  ...
  '4028': 'پیش از این به فرم ثبت‌نام پاسخ داده‌اید!',
  '4029': 'به همه‌ی سوالات اجباری پاسخ نداده‌اید!',
  ...
  '4033': 'لطفاً پایه‌ی تحصیلیتان را در قسمت اطلاعات دانش‌آموزی مشخص کنید.',
