...
// Wrap the component with forwardRef to accept a ref
const ScoreRecord = forwardRef<HTMLDivElement, ScoreBoardItemType>(
  ({ rank, name, score, currentUser }, ref) => {
    const conditionalUserBackground = currentUser
      ? "linear-gradient(180deg, #BBD043 0%, #BBD043 100%)"
      : "linear-gradient(180deg, rgba(255, 255, 255, 0.2) 0%, rgba(153, 153, 153, 0.02) 100%)";
